    ...
    <div>
        ...
        >
            ...
            <mu-form-item label="对方公司" help-text="合同主体不允许变更" prop="party_b" :rules="notNullRules">
                <mu-text-field v-model="form.party_b" disabled></mu-text-field>
            </mu-form-item>
            <mu-form-item label="合同类型">
                <mu-select v-model="form.type" full-width disabled>
                    <mu-option
                    ...
                    this.$axios
                        .post(
                            ...
                            qs.stringify({
                                ...
                                change_describe: this.form.describe,
                                change_type: 1
                            })
                        )
                        .then(response => {
