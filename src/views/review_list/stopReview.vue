<template>
    <div>
        ...
        <mu-list textline="two-line">
            ...
            <mu-divider shallow-inset></mu-divider>
            <mu-list-item>
                <mu-list-item-title>终止原因：{{changeData.changeDescribe}}</mu-list-item-title>
            </mu-list-item>
            <mu-divider shallow-inset></mu-divider>
        </mu-list>
        ...
        <mu-snackbar position="top" :open.sync="snackbar.open">
            {{snackbar.message}}
            <mu-button flat slot="action" color="secondary" @click="snackbar.open = false">Close</mu-button>
        </mu-snackbar>
    </div>
</template>
